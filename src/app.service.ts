    ...
    const gptResponse = await this.openai.responses.create({
      ...
      input: [
        ...
        },
        {
          ...
          id: 'fs_67d2e9d92f4481908fcd9bf4e5b45e1c0fbeb4318934cf02',
          status: 'completed',
          queries: [
            'Tell me about yourself candidate resume details',
            'Talk about yourself experience skills candidate resume',
            'Candidate resume summary including skills experiences accomplishments',
          ],
          results: null,
        },
        {
      ...
      tools: [
        {
          type: 'file_search',
          vector_store_ids: ['vs_67d2e5017ca8819190e41c426839bddf'],
          max_num_results: 2,
        },
      ],
      text: {
